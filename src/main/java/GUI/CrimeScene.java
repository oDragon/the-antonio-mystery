...
public class CrimeScene extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextField1.setText("ellalopez1992");
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGap(134, 263, Short.MAX_VALUE))
                            .addGroup(layout.createSequentialGroup()
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        new CrimeSceneDialog(null, true).show();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(jPasswordField1.getText().equals("frenchfries")){
            //change jLabel3 to display "Login Successful."
            jLabel3.setText("Login Successful.");
            //initiate the clue jDialogs
            new CrimeSceneClue(null, true).show();
        } else {
            //if the user enters the incorrect password, change jLabel3
            // to display "Incorrect Password."
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CrimeScene().setVisible(true);
            }
        });
    }

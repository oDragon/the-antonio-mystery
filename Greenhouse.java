...
public class Greenhouse extends javax.swing.JFrame {
    ...
    //initiate booleans for each button
    ...
    //when button 9 has been pressed
    private void jButton19ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton19ActionPerformed
        if (b8){
            //set the b9 boolean to true
            b9 = true;
            //disable the '9' button
            jButton19.setEnabled(false);
        }
    }//GEN-LAST:event_jButton19ActionPerformed

    //for the following action listeners:
    //the code checks that the preceding button has been pressed. If it has not,
    //then don't do anything. If it has been pressed, set the current button
    //being pressed to true and disable the current button.
    ...
    private void jButton10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton10ActionPerformed
        new GreenhouseDialog(null, true).show();
    }//GEN-LAST:event_jButton10ActionPerformed

    //first button so just set the corresponding boolean to true and disable
    //the button
    private void jButton13ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton13ActionPerformed
        b1 = true;
        jButton13.setEnabled(false);
        //testingGreenhouse.testActionListener();
    ...
    //when the user hits the 'Done' button
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        
        //check that the b9 boolean is true
        //(has the user completed the task)
        if(b9) {
            //make the jLabel display "Manifolds Unlocked!"
            jLabel1.setText("Manifolds Unlocked!");
            //initiate the clue jDialog
            new GreenhouseClue(null, true).show();
         }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Greenhouse().setVisible(true);
            }
        });
        //call testing method in testing java file
